...
\begin{minipage}[t]{0.70\textwidth}
    ...
    \begin{tightemize}
        ...
        \item Implemented a AWS Lambda System Pipeline for creating a Composite Image from multiple images using Computational Photography and Multi-View Geometry Principles.
