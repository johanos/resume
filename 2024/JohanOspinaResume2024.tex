...
\begin{minipage}[t]{0.70\textwidth}
    ...
    \begin{tightemize}
        ...
        \item Engineered a \textbf{\href{https://github.com/johanos/pollefeys-self-calibration-and-metric-reconstruction}{Python Software Pipeline \faIcon{link}}} to reproduce \textbf{\href{https://people.inf.ethz.ch/pomarc/pubs/PollefeysIJCV99.pdf}{research \faIcon{link}}} on calculating Camera Intrinsic Parameters using Image Correspondences and Projective Geometry.
    \end{tightemize}
    \sectionsep
    ...
    \begin{tightemize}
        ...
        \item Designed, implemented, and published \textbf{\href{https://dl.acm.org/doi/10.1145/3334480.3383180}{Doll House Projection Mapping Experience \faIcon{link}}} at CHI EA '20 with a team of 3 employees.
